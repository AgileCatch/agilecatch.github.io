...
## 2) RecyclerAdapter에서 ListAdapter로 교체하는 방법
...
1. 리사이클러뷰 아이템에 스위치 넣어주기 -> id값 부여
2. 투두리스트어댑터에서 클릭 바인딩 해주기

3. 프래그먼트 에서 리스트 어댑터 수정해주기 북마크 클릭 item 넣어주기
...
* addBookmarkItem 만들어주기

* Mainactivity에서 함수 작성해주기
